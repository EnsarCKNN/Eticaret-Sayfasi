    ...
    <div class="center_content">
      ...
      <?php  
        ...
        if(isset($_GET["kategori"])) {
          $kat= $_GET["kategori"];
          $query = $conn->query("SELECT * FROM ürün WHERE kategori = $kat", PDO::FETCH_ASSOC);
        }
        if(isset($_GET["marka"])) {
          $marka= $_GET["marka"];
          $query = $conn->query("SELECT * FROM ürün WHERE marka = $marka", PDO::FETCH_ASSOC);
        }
      ?>
        <?php foreach( $query as $kayit ) {  ?>
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><a href="urundetay.php?urunid=<?php echo $kayit["ürün_id"] ?>"><img src="images/<?php echo $kayit['ürün_resim'];?>" width="100" height="100" alt="" border="0" /></a></div>
          <div class="prod_price"><span class="price"> ₺<?php echo $kayit['ürün_fiyat'];?>  </span></div>
        </div>
