...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Ürün Detayları</div>
    
        
      <?php  
                    $urunid= $_GET['urunid'];
      $query = $conn->query("    SELECT  * FROM ürün WHERE ürün_id = $urunid", PDO::FETCH_ASSOC);
     ...
     ?>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="product_img_big"> <a href="javascript:popImage('images/<?php echo $kayit['ürün_resim']?>','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/<?php echo $kayit['ürün_resim']?>" width='100' heigth='100' alt="" border="0" /></a>
          ...
          <div class="details_big_box">
            <div class="product_title_big"><?php echo $kayit['ürün_name']?></div>
            ...
            <div class="prod_price_big"><span class="price"><?php echo $kayit['ürün_fiyat']?>TL</span></div>
